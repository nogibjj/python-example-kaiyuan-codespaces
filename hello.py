...
#write a function that yields a generator that randomly picks between three types pf fruit
def fruit_generator():
    fruits = ["apple", "banana", "orange"]
    while True:
        yield fruits[random.randint(0,2)]

#invoke fruit_generator function and print the result of the generator for 5 runs
for i in range(5):
